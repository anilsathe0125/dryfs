            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumbs">
                        <li><a href="{{ route('frontend.index') }}">{{ __('Home') }}</a>
                        </li>
                        <li class="separator"></li>
                        <li><a href="{{ route('frontend.catalog') }}">{{ __('Shop') }}</a>
                        </li>
                        <li class="separator"></li>
                        <li>{{ $item->name }}</li>
                    </ul>
            ...
            <div class="col-xxl-5 col-lg-6 col-md-6">
                <div class="product-gallery">
                    ...
                    <div class="product-carousel owl-carousel gallery-wrapper">
                        <div class="gallery-item" itemscope data-hash="one"><a href="{{ asset($item->photo) }}" data-size="1000x1000"><img src="{{ asset($item->photo) }}" alt="Product"></a></div>
                    ...
                    <ul class="product-thumbnails">
                        <li class="active"><a href="#one"><img src="{{ asset($item->photo) }}" alt="Product"></a></li>
                            ...
                            <div class="t-c-b-area">
                                @if ($item->brand_id)
                                    <div class="pt-1 mb-1"><span class="text-medium">{{ __('Brand') }}:</span>
                                        <a href="{{ route('frontend.catalog') . '?brand=' . $item->brand->slug }}">{{ $item->brand->name }}</a>
                                    </div>
                                @endif
                        ...
                        @foreach ($related_items as $related)
                            <div class="slider-item">
                                <div class="product-card">
                                    ...
                                    @endif
                                    <a class="product-thumb" href="{{ route('frontend.product', $related->slug) }}"><img class="lazy" src="{{ $setting->loader ? asset($setting->loader) : asset('frontend/images/ajax_loader.gif')}}" data-src="{{ asset($related->thumbnail) }}" alt="Product"></a>
                                    <div class="product-card-body">
                                        <div class="product-category"><a href="{{ route('frontend.catalog') . '?category=' . $related->category->slug }}">{{ $related->category->name }}</a>
                                        </div>
                                    ...
                                    <div class="product-button-group">
                                        ...
                                        @else
                                            <a class="product-button" href="{{ route('frontend.product', $related->slug) }}"><i class="icon-arrow-right"></i><span>{{ __('Details') }}</span></a>
                                        @endif
                                    </div>
                                </div>
                            </div>
