                                ...
                                <tbody>
                                    @if ($wishlist_items->count() > 0)
                                        @foreach ($wishlist_items as $product)
                                            <tr>
                                                <td>
                                                    <div class="product-item"><a class="product-thumb" href="{{ route('frontend.product', $product->slug) }}"><img src="{{ asset($product->photo) }}" alt="Product"></a>
                                                        <div class="product-info">
                                                            <h4 class="product-title"><a href="{{ route('frontend.product', $product->slug) }}">{{ $product->name }}</a></h4>
