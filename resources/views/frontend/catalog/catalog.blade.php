        ...
        @if($items->count() > 0)
            @if ($checkType != 'list')
                ...
                <div class="col-xxl-3 col-md-4 col-6">
                    ...
                    @endif
                    <a class="product-thumb" href="{{route('frontend.product',$item->slug)}}"><img class="lazy" src="{{ $setting->loader ? asset($setting->loader) : asset('frontend/images/ajax_loader.gif')}}" data-src="{{asset($item->thumbnail)}}" alt="Product"></a>
    ...
    <script type="text/javascript" src="{{ asset('frontend/js/catalog.js') }}"></script>
