                ...
                <div class="mb-2">
                    <div class="card">
                        <div class="card-body d-flex flex-row justify-content-between align-items-center">
                            <p class="mb-0"><span class="badge badge-primary">{{ $ticket->status }}</span>
                                {{ __('Subject :') }} {{ $ticket->subject }}</p>
                            <a href="{{ route('user.ticket') }}" class="btn btn-primary btn-sm">{{ __('Back') }}</a>
                            @if ($ticket->file)
                                <a href="{{ asset($ticket->file) }}" title="Download" class="btn btn-primary btn-sm" download> {{ __('Attachment') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
